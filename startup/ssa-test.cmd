...
#iocshLoad("psu.iocsh", "PSU_NUM=2")
#iocshLoad("psu.iocsh", "PSU_NUM=3")
#iocshLoad("psu.iocsh", "PSU_NUM=4")
#iocshLoad("psu.iocsh", "PSU_NUM=5")

#epicsEnvSet(PREFIX_SSM, "$(CAB_SSA):$(DISCIPLINE)-SSM")
#epicsEnvSet(IP_ADDR_BASE, "10.100")
#epicsEnvSet(POLL_MS, "1000")
#iocshLoad("ssm.iocsh", "SSM_NUM=1")
#iocshLoad("ssm.iocsh", "SSM_NUM=2")
#iocshLoad("ssm.iocsh", "SSM_NUM=3")
#iocshLoad("ssm.iocsh", "SSM_NUM=4")
#iocshLoad("ssm.iocsh", "SSM_NUM=5")
#iocshLoad("ssm.iocsh", "SSM_NUM=6")
#iocshLoad("ssm.iocsh", "SSM_NUM=7")
#iocshLoad("ssm.iocsh", "SSM_NUM=8")
